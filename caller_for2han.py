...
from Base6_2HAN_MAX import fhan2_max
...
#-----------------------------------------------------------------------------------------------------------------------------        
print ('Build model...')
model, model1 = fhan2_max(MAX_NB_WORDS, WORD_LIMIT, SENT_LIMIT, EMBEDDING_DIM, WORDGRU, embedding_matrix, DROPOUTPER)
print model.summary()
...
class ModelSave(callbacks.Callback):
    def on_epoch_end(self, epoch, logs={}):
        model1.save('SavedModels/2han_max_model_wordEncoder_epoch_{}.h5'.format(epoch))
        model.save('SavedModels/2han_max_model_epoch_{}.h5'.format(epoch))
