...
#-----------------------------------------------------------------------------------------------------------------------------        
print ('Build model...')
model = fhan2_max(MAX_NB_WORDS, WORD_LIMIT, SENT_LIMIT, EMBEDDING_DIM, WORDGRU, embedding_matrix, DROPOUTPER)
print model.summary()
...
class ModelSave(callbacks.Callback):
    def on_epoch_end(self, epoch, logs={}):
        model.save('SavedModels/han_max_epoch_{}.h5'.format(epoch))
